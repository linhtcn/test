...
import projectcss from "./plasmic.module.css"; // plasmic-import: o377HB3bFr4ZkQwQAbxSoD/projectcss
import sty from "./PlasmicConnectWalletViewMintingNftDetails.module.css"; // plasmic-import: Io1XBtDGNA-F/css

import HomeSvgIcon from "./icons/PlasmicIcon__HomeSvg"; // plasmic-import: 7bi-xfBU4A9i/icon
...
function PlasmicConnectWalletViewMintingNftDetails__RenderFunc(props: {
  ...
  const globalVariants = ensureGlobalVariants({
    screen: useScreenVariantsbwki6Q2VtuOc()
  });
  ...
  return (
    <React.Fragment>
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__xGaB)}>
            <div className={classNames(projectcss.all, sty.freeBox__k5LXe)}>
              <div className={classNames(projectcss.all, sty.freeBox__mrDoz)}>
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__tpTop)}
                >
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__r9TmM)}
                  >
                    <HomeSvgIcon
                  ...
                  <ConnectWalletButton
                    className={classNames(
                      "__wab_instance",
                      sty.connectWalletButton__x5SBz
                    )}
                    ...
                    copyIcon={
                      <CopyIcon
                        className={
                          "" +
                          " " +
                          classNames("__wab_instance", sty.copyIcon__gJbky)
                        }
                        iconColor={"#27273A"}
                      />
                    }
                    ...
                    userIcon={
                      <UserIcon
                        className={
                          "" +
                          " " +
                          classNames("__wab_instance", sty.userIcon__zivTy)
                        }
                      />
                    }
                  />
              ...
              <div className={classNames(projectcss.all, sty.freeBox__z0MMs)}>
                <div className={classNames(projectcss.all, sty.freeBox__gOWt)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__hn5Sx)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__jsi1K)}
                    >
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__knINm)}
                        displayHeight={"100%"}
